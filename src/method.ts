  ...
  for (const note of music.notes) {
    ...
    if (note.duration === Duration.GRACE || note.duration === Duration.GRACE_SLASH) {
      ...
      if (isRest) {
        ...
        else if (note.duration === Duration.HALF) features.add(Technique.HalfRest);
        else if (note.duration === Duration.QUARTER) features.add(Technique.QuarterRest);
        else if (note.duration === Duration.EIGHTH) features.add(Technique.EighthRest);
        else if (note.duration === Duration.SIXTEENTH) features.add(Technique.SixteenthRest);
      } else {
        if (note.duration === Duration.WHOLE) features.add(Technique.WholeNote);
          ...
          features.add(dotted ? Technique.DottedQuarterNote : Technique.QuarterNote);
        else if (note.duration === Duration.EIGHTH)
          features.add(dotted ? Technique.DottedEighthNote : Technique.EighthNote);
